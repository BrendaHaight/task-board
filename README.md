...
![Task board page](task-board/Develop/images/Task-board-page.png)
...
![Add task](task-board/Develop/images/adding-ask.png)
...
![tasks](task-board/Develop/images/task-around-columns.png)
Deleting a Task:
